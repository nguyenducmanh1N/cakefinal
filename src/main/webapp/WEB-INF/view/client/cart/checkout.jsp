        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <head>
                    ...
                    <br>
                    <meta charset="utf-8">
                    <title> Thanh toán - Sweetie Pies</title>
                                            ...
                                            <div class="bg-light rounded">
                                                ...
                                                <div
                                                    ...
                                                    <c:if test="${not empty discountValue }">
                                                            ...
                                                            <h5 class="mb-0 ps-4 me-4">Voucher :</h5>
                                                            <p class="mb-0 pe-4">
                                                                -
                                                                <fmt:formatNumber type="number" value="${discountValue}" />% =
                                                            </p>
                                                    </c:if>
                                                    <!-- <c:if test="${not empty appliedVoucherCode }">
                                                        <p class="mb-0 pe-4" name="voucherCode" >
                                                            <fmt:formatNumber   value="${appliedVoucherCode}" />
                                                        </p>
                                                    </c:if> -->
